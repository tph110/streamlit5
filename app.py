...
# Configuration
# -------------------------
MODEL_URL = "https://huggingface.co/Skindoc/streamlit12/resolve/main/best_model_20251130_205132.pth"
...
def main():
    ...
    st.markdown("""
        ...
        8-Class Dermoscopic Image Classification | EfficientNet-B4 trained on 43,810 images (ISIC2019 + BCN20000 + BOSQUE + Derm7pt) | Macro F1 93.0% | Macro AUC 99.4% | Balanced Accuracy 91.4%
        </p>
        <hr>
    ...
    with st.sidebar:
        ...
        st.metric("Macro F1 Score", "0.930")
        st.metric("Macro AUC", "0.994")
        st.metric("Balanced Accuracy", "0.914")
        st.metric("Training Dataset", "43,810 images")
    ...
    <div style="text-align: center; color: #999; padding: 20px;">
        <p><strong>Model:</strong> EfficientNet-B4 | Trained on 43,810 images (ISIC2019 + BCN20000 + BOSQUE + Derm7pt) | 8-class classification</p>
        <p><strong>Performance:</strong> Macro AUC 99.4% | F1 93.0% | Clinical-grade accuracy</p>
